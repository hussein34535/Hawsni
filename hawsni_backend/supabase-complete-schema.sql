...
INSERT INTO categories (name, description, sort_order) VALUES
  ('Men', 'Men''s clothing and accessories', 1),
  ('Women', 'Women''s clothing and accessories', 2),
  ('Kids', 'Kids'' clothing and accessories', 3),
  ('Accessories', 'Fashion accessories', 4),
  ('Bags', 'Bags and luggage', 5)
