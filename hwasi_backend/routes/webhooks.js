            ...
            if (hwasiStatus) {
                ...
                if (order) {
                    ...
                    if (order.status !== hwasiStatus) {
                        ...
                        if (!updateError) {
                            console.log(`[Bosta Webhook] Updated order ${order.order_number || order.id} to ${hwasiStatus}.`);
