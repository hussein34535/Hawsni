    ...
    return (
        <div className="h-[100dvh] flex flex-col bg-white overflow-hidden" dir="rtl">
            ...
            <div className="p-3 md:p-4 shrink-0">
                <button 
                    onClick={() => router.push('/')}
                    className="flex items-center gap-1.5 text-gray-500 hover:text-gray-900 transition-colors group w-fit"
                >
                    <ArrowLeft size={18} className="rotate-180 group-hover:-translate-x-1 transition-transform" />
                    <span className="text-xs font-bold font-cairo">العودة</span>
                </button>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-4 overflow-y-auto">
                <div className="w-full max-w-[360px] pb-4">
                    <div className="text-center mb-6">
                        <div className="w-14 h-14 bg-[#0E4435] rounded-2xl mx-auto flex items-center justify-center mb-3 shadow-lg">
                            <img src="/logo.png" alt="Hawsni Logo" className="w-10 h-10 object-contain invert brightness-0" />
                        </div>
                        <h1 className="text-xl md:text-2xl font-black text-gray-900 mb-1 font-cairo">تسجيل الدخول</h1>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-3">
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pr-10 pl-3 py-2.5 bg-gray-50 border border-transparent rounded-xl focus:bg-white focus:border-[#0E4435]/20 focus:ring-2 focus:ring-[#0E4435]/10 outline-none transition-all text-right text-sm font-bold placeholder:text-gray-300"
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center justify-between mr-1">
                                <label className="text-[11px] font-black text-gray-400 font-cairo">كلمة المرور</label>
                                <Link href="/forgot-password" title="forgot-password">
                                    <span className="text-[10px] font-black text-[#0E4435] hover:opacity-70 transition-opacity font-cairo">
                                        نسيت كلمة المرور؟
                                    </span>
                                </Link>
                            </div>
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-2.5 px-4 mt-2 bg-[#0E4435] hover:bg-[#0a3126] text-white rounded-xl font-black text-sm shadow-md shadow-[#0E4435]/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] font-cairo"
                        >
                            {isLoading ? (
