            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-[420px]">
                    ...
                    <button
                        ...
                        className="w-full py-4 px-6 bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-900 rounded-2xl font-black text-sm shadow-sm transition-all flex items-center justify-center gap-3 active:scale-[0.98] font-cairo mt-6"
                    >
