...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1359: (x0,x1,x2,x3) => globalThis.firebase_analytics.logEvent(x0,x1,x2,x3),
      _1364: (x0,x1) => globalThis.firebase_analytics.initializeAnalytics(x0,x1),
      _1367: (x0,x1) => x0.getItem(x1),
      _1368: (x0,x1) => x0.removeItem(x1),
      ...
      _1387: () => globalThis.firebase_core.SDK_VERSION,
      _1393: x0 => x0.apiKey,
      _1395: x0 => x0.authDomain,
      _1397: x0 => x0.databaseURL,
      _1399: x0 => x0.projectId,
      _1401: x0 => x0.storageBucket,
      _1403: x0 => x0.messagingSenderId,
      _1405: x0 => x0.measurementId,
      _1407: x0 => x0.appId,
      _1409: x0 => x0.name,
      _1410: x0 => x0.options,
      _1413: (x0,x1) => x0.debug(x1),
      ...
      _1416: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1417: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1418: (x0,x1) => x0.createScriptURL(x1),
      ...
      _1451: (o, p, r) => o.replace(p, () => r),
      _1452: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1453: s => s.toUpperCase(),
      _1454: s => s.trim(),
      _1455: s => s.trimLeft(),
      _1456: s => s.trimRight(),
      _1457: (string, times) => string.repeat(times),
      _1458: Function.prototype.call.bind(String.prototype.indexOf),
      _1459: (s, p, i) => s.lastIndexOf(p, i),
      _1460: (string, token) => string.split(token),
      _1461: Object.is,
      _1462: o => o instanceof Array,
      _1463: (a, i) => a.push(i),
      _1464: (a, i) => a.splice(i, 1)[0],
      _1466: (a, l) => a.length = l,
      _1467: a => a.pop(),
      _1468: (a, i) => a.splice(i, 1),
      _1469: (a, s) => a.join(s),
      _1470: (a, s, e) => a.slice(s, e),
      _1472: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1473: a => a.length,
      _1475: (a, i) => a[i],
      _1476: (a, i, v) => a[i] = v,
      _1478: o => {
      ...
      _1479: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1481: o => o instanceof Uint8Array,
      _1482: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1483: o => o instanceof Int8Array,
      _1484: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1485: o => o instanceof Uint8ClampedArray,
      _1486: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1487: o => o instanceof Uint16Array,
      _1488: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1489: o => o instanceof Int16Array,
      _1490: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1491: o => o instanceof Uint32Array,
      _1492: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1493: o => o instanceof Int32Array,
      _1494: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1496: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1497: o => o instanceof Float32Array,
      _1498: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1499: o => o instanceof Float64Array,
      _1500: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1501: (t, s) => t.set(s),
      _1502: l => new DataView(new ArrayBuffer(l)),
      _1503: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1504: o => o.byteLength,
      _1505: o => o.buffer,
      _1506: o => o.byteOffset,
      _1507: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1508: (b, o) => new DataView(b, o),
      _1509: (b, o, l) => new DataView(b, o, l),
      _1510: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1511: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1512: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1513: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1514: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1515: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1516: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1517: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1518: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1519: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1520: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1521: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1524: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1525: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1526: Function.prototype.call.bind(DataView.prototype.getFloat32),
      ...
      _1554: () => new XMLHttpRequest(),
      _1555: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1556: x0 => x0.send(),
      _1558: () => new FileReader(),
      _1559: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1562: () => new AbortController(),
      _1563: x0 => x0.abort(),
      _1564: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1565: (x0,x1) => globalThis.fetch(x0,x1),
      _1566: (x0,x1) => x0.get(x1),
      _1567: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1567(f,arguments.length,x0,x1,x2) }),
      _1568: (x0,x1) => x0.forEach(x1),
      _1569: x0 => x0.getReader(),
      _1570: x0 => x0.cancel(),
      _1571: x0 => x0.read(),
      ...
      _1597: (x0,x1) => x0.key(x1),
      _1598: (x0,x1) => x0.item(x1),
      _1599: x0 => x0.trustedTypes,
      _1600: (x0,x1) => { x0.text = x1 },
      _1603: (x0,x1) => x0.getContext(x1),
      _1609: (s, m) => {
        try {
      ...
      _1642: o => [o],
      _1643: (o0, o1) => [o0, o1],
      _1644: (o0, o1, o2) => [o0, o1, o2],
      _1645: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1668: (o, p) => o[p],
      _1669: (o, p, v) => o[p] = v,
      _1670: (o, p) => delete o[p],
      _1671: x0 => x0.random(),
      _1672: (x0,x1) => x0.getRandomValues(x1),
      _1673: () => globalThis.crypto,
      _1674: () => globalThis.Math,
      _1675: Function.prototype.call.bind(Number.prototype.toString),
      ...
      _1699: x0 => x0.style,
      _1702: x0 => x0.src,
      _1703: (x0,x1) => { x0.src = x1 },
      _1704: x0 => x0.naturalWidth,
      _1705: x0 => x0.naturalHeight,
      _1721: x0 => x0.status,
      _1722: (x0,x1) => { x0.responseType = x1 },
      _1724: x0 => x0.response,
      _1773: (x0,x1) => { x0.responseType = x1 },
      _1774: x0 => x0.response,
      _1850: x0 => x0.style,
      _1863: (x0,x1) => { x0.oncancel = x1 },
      _1869: (x0,x1) => { x0.onchange = x1 },
      _1909: (x0,x1) => { x0.onerror = x1 },
      _2209: (x0,x1) => { x0.download = x1 },
      _2234: (x0,x1) => { x0.href = x1 },
      _2282: (x0,x1) => { x0.src = x1 },
      _2293: x0 => x0.width,
      _2295: x0 => x0.height,
      _2776: (x0,x1) => { x0.accept = x1 },
      _2790: x0 => x0.files,
      _2816: (x0,x1) => { x0.multiple = x1 },
      _2834: (x0,x1) => { x0.type = x1 },
      _3086: (x0,x1) => { x0.type = x1 },
      _3094: (x0,x1) => { x0.crossOrigin = x1 },
      _3096: (x0,x1) => { x0.text = x1 },
      _3128: x0 => x0.width,
      _3129: (x0,x1) => { x0.width = x1 },
      _3130: x0 => x0.height,
      _3131: (x0,x1) => { x0.height = x1 },
      _3550: () => globalThis.window,
      _3612: x0 => x0.navigator,
      _3874: x0 => x0.trustedTypes,
      _3876: x0 => x0.localStorage,
      _3980: x0 => x0.geolocation,
      _3983: x0 => x0.mediaDevices,
      _3985: x0 => x0.permissions,
      _3999: x0 => x0.userAgent,
      _4000: x0 => x0.vendor,
      _4207: x0 => x0.length,
      _6111: x0 => x0.type,
      _6112: x0 => x0.target,
      _6152: x0 => x0.signal,
      _6224: () => globalThis.document,
      _6306: x0 => x0.body,
      _6308: x0 => x0.head,
      _6637: (x0,x1) => { x0.id = x1 },
      _6664: x0 => x0.children,
      _7983: x0 => x0.value,
      _7985: x0 => x0.done,
      _8165: x0 => x0.size,
      _8166: x0 => x0.type,
      _8169: (x0,x1) => { x0.type = x1 },
      _8172: x0 => x0.name,
      _8173: x0 => x0.lastModified,
      _8178: x0 => x0.length,
      _8184: x0 => x0.result,
      _8676: x0 => x0.url,
      _8678: x0 => x0.status,
      _8680: x0 => x0.statusText,
      _8681: x0 => x0.headers,
      _8682: x0 => x0.body,
      _11076: (x0,x1) => { x0.display = x1 },
      _12298: x0 => x0.name,
      _12299: x0 => x0.message,
      _13014: () => globalThis.console,
      _13042: x0 => x0.name,
      _13043: x0 => x0.message,
      _13044: x0 => x0.code,
