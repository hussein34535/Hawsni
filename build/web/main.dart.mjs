...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1362: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1363: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1364: x0 => globalThis.firebase_core.getApp(x0),
      _1365: () => globalThis.firebase_core.getApp(),
      _1366: (x0,x1) => x0.debug(x1),
      ...
      _1369: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1370: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1371: (x0,x1) => x0.createScriptURL(x1),
      _1372: (x0,x1,x2) => x0.createScript(x1,x2),
      _1373: (x0,x1) => x0.appendChild(x1),
      _1374: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1374(f,arguments.length,x0) }),
      _1375: () => globalThis.firebase_core.SDK_VERSION,
      _1381: x0 => x0.apiKey,
      _1383: x0 => x0.authDomain,
      _1385: x0 => x0.databaseURL,
      _1387: x0 => x0.projectId,
      _1389: x0 => x0.storageBucket,
      _1391: x0 => x0.messagingSenderId,
      _1393: x0 => x0.measurementId,
      _1395: x0 => x0.appId,
      _1397: x0 => x0.name,
      _1398: x0 => x0.options,
      ...
      _1521: () => globalThis.performance,
      _1522: () => globalThis.JSON,
      _1523: x0 => x0.measure,
      _1524: x0 => x0.mark,
      _1525: x0 => x0.clearMeasures,
      _1526: x0 => x0.clearMarks,
      _1527: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1528: (x0,x1,x2) => x0.mark(x1,x2),
      _1529: x0 => x0.clearMeasures(),
      _1530: x0 => x0.clearMarks(),
      _1531: (x0,x1) => x0.parse(x1),
      _1532: (ms, c) =>
